                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      TextFormField(
                        decoration:
                            InputDecoration(labelText: 'Student Seat Price'),
                        enabled: false,
                      ...
                      TextFormField(
                        decoration:
                            InputDecoration(labelText: 'General Seat Price'),
                        enabled: false,
                        keyboardType: TextInputType.name,
                      ...
                      TextFormField(
                        decoration:
                            InputDecoration(labelText: 'Disabled Seat Price'),
                        enabled: false,
                        keyboardType: TextInputType.name,
